...
{
var agree=confirm("Tem certeza que deseja deletar essa categoria?");
if (agree)
	return true ;
else
	return false ;
...
<table width="506" border="1" align="center">
  <tr> 
    <td colspan="2"> <div align="center"><strong>Categorias cadastradas:</strong></div>
      </td>
  </tr>
  <?php do { ?>
  <tr> 
    <td width="248"><div align="center"><a href="excluir_cat.php?cod_cat=<?php echo $row_Recordset1['cod_cat']; ?>" onClick="return confirmSubmit()">Clique 
        aqui para excluir</a></div></td>
    <td width="242"><div align="center"><?php echo $row_Recordset1['nome_cat']; ?></div></td>
  </tr>
